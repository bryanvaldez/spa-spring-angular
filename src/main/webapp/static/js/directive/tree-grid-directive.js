(function () {
    angular
        .module('template/treeGrid/treeGrid.html', [], function ($interpolateProvider) {
        ...
        .run([
            ...
            function ($templateCache) {
                $templateCache.put('template/treeGrid/treeGrid.html',
                    ...
                    "       <td><a ng-if=\"row.branch.MostrarCheck\" ng-hide=\"row.branch.level===5\" ng-click=\"user_clicks_branch(row.branch)\"><i ng-class=\"row.tree_icon\"\n" +
