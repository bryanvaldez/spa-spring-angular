...
<t:master  title="dashboard">             
    ...
    <div class="contenidoEstandar" ng-controller="onpeComposer as ctrl" ng-cloak >  
        ...
        <div ng-if="ctrl.option.N_ORDEN == 1" ng-cloak>   
            <jsp:include page="/WEB-INF/adan/step1/configuracionObs.jsp"/>
        </div>   
        <div ng-if="ctrl.option.N_ORDEN == 2" ng-cloak>   
            <jsp:include page="/WEB-INF/adan/step1/reglasObs.jsp"/>	 
        </div>                        
        <div ng-if="ctrl.option.N_ORDEN == 3" ng-cloak>   
            <jsp:include page="/WEB-INF/adan/step1/fichaObs.jsp"/>
        </div>        
        <div ng-if="ctrl.option.N_ORDEN == 4" ng-cloak>   
            <jsp:include page="/WEB-INF/adan/step2/cargaObs.jsp"/>
        </div>
        <div ng-if="ctrl.option.N_ORDEN == 5" ng-cloak>   
            <jsp:include page="/WEB-INF/adan/step2/asignacionSolucionObs.jsp"/>
        </div>
        <div ng-if="ctrl.option.N_ORDEN == 6" ng-cloak>   
            <jsp:include page="/WEB-INF/adan/step3/mainObs.jsp"/>
        </div>
        ...
        <div ng-if="ctrl.option.N_ORDEN == 8" ng-cloak>   
            <jsp:include page="/WEB-INF/adan/step8/mainObs.jsp"/>
        </div>  
        <div ng-if="ctrl.option.N_ORDEN == 9" ng-cloak>
            <jsp:include page="/WEB-INF/adan/step9/mainObs.jsp"/>
        </div> 
        ...
        <div ng-if="ctrl.option.N_ORDEN == 11" ng-cloak>
            <jsp:include page="/WEB-INF/adan/step11/mainObs.jsp"/>
        </div> 
        <div ng-if="ctrl.option.N_ORDEN == 12" ng-cloak>
            <jsp:include page="/WEB-INF/adan/step12/mainObs.jsp"/>
        </div> 
        <div ng-if="ctrl.option.N_ORDEN == 13" ng-cloak>
            <jsp:include page="/WEB-INF/adan/step13/mainObs.jsp"/>
        </div>   
