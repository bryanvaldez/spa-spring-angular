    ...
    <div ng-hide="ctrl.viewProcedure" class="contdmoree" ng-cloak>
        <form name="localForm" ng-submit="localForm.$valid && ctrl.submitLocal()" novalidate >
            <section class="columnaDiviTres primeraSeccion">  
                ...
                <article>
                    ...
                    <onpe-adan-elector-historial ng-if="ctrl.section.viewElector" 
                        data="ctrl.elector"
            ...
            <section class="columnaDiviTres ">                
                <onpe-reporte-mapa ng-show="ctrl.section.reporteBase"
                    mapa="mapa"                    
                    ></onpe-reporte-mapa>
                <onpe-adan-elector ng-if="ctrl.section.viewElector"
                    data="ctrl.elector"                    
                    disabled-elector-vip="false"
                ...
                <article ng-show="ctrl.section.reporteBase">                
                    <jsp:include page="/WEB-INF/adan/mantenimiento/reporteLocalSolucion.jsp"/>
                </article>  
            ...
            <section class="columnaDiviTres terceraSeccion">
               ...
               <onpe-reporte-mesa ng-show="ctrl.section.reporteBase || ctrl.section.reporteByMesa" 
                ...
                <md-button ng-if="ctrl.section.viewLocal && ctrl.ubigeoOdpe!=null" class="md-primary md-raised estilosBotonGeneral botonResaltantes" 
                           type="submit" ng-disabled="ctrl.isSubmitLocal">CREAR NUEVO LOCAL
                </md-button>            
                
                <onpe-adan-asignar ng-if="ctrl.section.asignar"
                    type="ctrl.view"
                    elector="ctrl.elector"
                    mesas="ctrl.asignarReasignar"
                    localtemp="ctrl.local"
                    btn-select-local="ctrl.activeAsignarReasignar(data)"
                    ></onpe-adan-asignar>
        ...
        <footer class="OpcionesFooterGenerales">
            <div class="colum2 text-izq  alineadoIzquieda"> 
                ...
                <md-button class="md-fab md-primary botonFoter estilosBotonGeneral" ng-click="abrirResumen(ev)">
                    <i class="material-icons">&#xE88F;</i>
                    <md-tooltip md-direction="top">Resumen</md-tooltip>
                </md-button>
                <md-button class="md-fab md-primary botonFoter estilosBotonGeneral" ng-click="abrirMesasPorLocal()">
                  <i class="material-icons">&#xE884;</i>
                    <md-tooltip md-direction="top">Relación de Mesas Existentes</md-tooltip>
                </md-button>
            </div>          
