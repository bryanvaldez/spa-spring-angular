    ...
    <article>
        <div class="contenidoTituloMantenimiento EstadoOkMantenimiento"> <!-- Otro Estado = EstadoErrorMantenimiento -->
            <md-input-container ng-class="md-padding" >
                ...
                <textarea name='C_NOMBRE' ng-model="ctrl.local.C_NOMBRE" required uppercased letters-and-number2 maxlength="100" ng-maxlength="100"
                       ng-disabled="!ctrl.local.B_ESTADO"></textarea>
            ...
            <md-input-container  ng-if="!ctrl.isEditSolucion" class="SeccionBotonesTituloRecuadro">
                <md-button type="sumbit " class=" md-fab md-primary botonFoter estilosBotonGeneral ">
        ...
        <div class="ContenedorMantenimientoCard EstadoOkMantenimiento">
            <md-tabs md-dynamic-height md-border-bottom md-selected="ctrl.selectedIndexTab">
                <md-tab md-tab- label="ID: [[ctrl.local.C_CODIGO]]">
                    <md-content class="md-padding">
                        <div class="contenedorshishtStandar"> 
                            <label>Deshabilitado</label>
                            <md-switch ng-model="ctrl.local.B_ESTADO" aria-label="status" ng-click="ctrl.enabledDisabledLocal()" layout-align="center"></md-switch>
                        ...
                        <md-input-container class="EstiloInput InputSinError inputmedio">
                            ...
                            <input name='C_CODIGO' ng-model="ctrl.local.C_CODIGO" valid-number maxlength="4" minlength="4" ng-maxlength="4" ng-minlength="4" required ng-disabled="ctrl.stepGeneral >= 13 || !ctrl.local.B_ESTADO">
                        ...
                        <div class="colum2Card">
                            <md-button ng-click="ctrl.menos()" class="md-fab butonpekeAsignado md-primary estilosBotonGeneral" ng-disabled="ctrl.stepGeneral >= 13 || !ctrl.local.B_ESTADO" >
                                <i class="material-icons">&#xE15B;</i>
                            </md-button>
                            <md-input-container class="EstiloInput InputSinError  alineadoCentro inputPequerespo">
                                <label>Mesas</label>                                        
                                <input name='N_MESAS_ACTUALIZADAS' ng-model="ctrl.local.N_MESAS_ACTUALIZADAS" valid-number required maxlength="3" ng-maxlength="3" ng-disabled="!ctrl.local.B_ESTADO">
                                <div ng-messages="localForm.N_MESAS_ACTUALIZADAS.$error">
                                    <div ng-message="required">Campo Requerido</div>                                            
                                </div>                            
                            </md-input-container>   
                            <md-button ng-click="ctrl.mas()" class="md-fab butonpekeAsignado md-primary estilosBotonGeneral" ng-disabled="ctrl.stepGeneral >= 13 || !ctrl.local.B_ESTADO" >
                                <i class="material-icons">&#xE145;</i>
                            </md-button>
                        </div>
                        ...
                        <md-input-container class="EstiloInput InputSinError inputfull" >
                            ...
                            <input name='C_DIRECCION' ng-model="ctrl.local.C_DIRECCION" uppercased letters-and-number2 ng-disabled="!ctrl.local.B_ESTADO">
                        ...
                        <md-input-container class="EstiloInput InputSinError inputfull" >
                            ...
                            <input name='C_REFERENCIA' ng-model="ctrl.local.C_REFERENCIA" uppercased letters-and-number2 ng-disabled="!ctrl.local.B_ESTADO">
                        ...
                        <md-input-container class="EstiloInput InputSinError inputmedio" >
                            <label>Latitud</label>
                            <input name='N_LATITUD' ng-model="ctrl.local.N_LATITUD" valid-coordenadas maxlength="18" ng-maxlength="18" ng-disabled="!ctrl.local.B_ESTADO">
                        ...
                        <md-input-container class="EstiloInput InputSinError inputmedio" >
                            ...
                            <input name='N_LONGITUD' ng-model="ctrl.local.N_LONGITUD" valid-coordenadas maxlength="18" ng-maxlength="18" ng-disabled="!ctrl.local.B_ESTADO">
                            <div ng-messages="localForm.N_LONGITUD.$error">
                                <div ng-message="required">Campo Requerido</div>                                            
                            </div>
                        </md-input-container>   

                        <md-checkbox ng-model="ctrl.local.B_CCPP" aria-label="Checkbox 1" class="CheckCentroPo" ng-click="ctrl.toggleCCPP(ctrl.local.B_CCPP)" ng-disabled="ctrl.stepGeneral >= 13 || !ctrl.local.B_ESTADO">
                            Centro Poblado
                        </md-checkbox>
                        <md-input-container class="EstiloInput InputSinError ReferenciaCentroPoblado" ng-if="ctrl.isVisibleCCPP">
                            ...
                            <input name='C_CCPP' ng-model="ctrl.local.C_CCPP" required="!ctrl.isVisibleCCPP" uppercased letters-and-number2 maxlength="100" ng-maxlength="100" ng-disabled="!ctrl.local.B_ESTADO">
                ...
                <md-tab label="Mesas Asignadas: [[ctrl.mesas.length]]" ng-hide="!ctrl.isEditSolucion">
                    <md-content class="md-padding">                        
                        <div ng-if="ctrl.mesas.length === 0">
                            El Local de Votación no cuenta con mesas asignadas...
                        </div>                        
                    </md-content>
                    <md-content class="md-padding">                                                                        
                        <div class="TarjetiaNMesa" ng-repeat="mesa in ctrl.mesas">
                            ...
                            <md-checkbox ng-checked="ctrl.exists(mesa.MESA, ctrl.asignarReasignar)" ng-click="ctrl.toggle(mesa.MESA, ctrl.asignarReasignar)"                                          
                                         aria-label="Checkbox" ng-disabled="ctrl.stepGeneral > 13 || !ctrl.local.B_ESTADO"></md-checkbox>
