                ...
                <div class="estiloTarjeta" > 
                    <div class="SistemaComentatext">
                        ...
                        <md-input-container   class="EstiloInput InputSinError">
                            ...
                            <input ng-disabled="true" name='resolA' ng-model="documento.resolucion" autocomplete="off" valid-number maxlength="15" ng-maxlength="15">
                        </md-input-container>
                        <!--<span> - </span>
                        <md-input-container class="EstiloInput InputSinError">
                            <label ng-show="false"></label>
                        ...
                        <div class="cargarDatosInputCont">
                            <div layout="row" flex="100" class="formularioOdenadoPopUp">
                                <lf-ng-md-file-input ng-disabled="true" lf-api="apiFile" lf-files="archivo" progress                                                
                    ...
                    <div class="ParteDividiaPreferencial">
                        <h2 class="tituloSecundario"><b>Máximo de Electores por Mesa en no Centros Poblados</b>
                            ...
                            <md-button class="md-fab md-primary botonFoter estilosBotonGeneral EditButon" md-theme="" aria-label="Use Android" ng-click="openTiposSolucion()" ng-disabled="true">
                        ...
                        <div class="ContenedorSolucionesScroll">
                            <article ng-if="solucion.estado === 1"  ng-repeat="solucion in tiposSolucion" class="tipoSolucionAgregada ">
                                ...
                                <md-input-container class="ParteDividiaPreferencialPer EstiloInput InputSinError alineadoCentro" >
                                    <label ng-show="false"></label>
                                    <input name='electores_[[$index]]' ng-disabled="true" ng-model="solucion.electores" ng-change="changeCantidadElectores($index, solucion.electores)" autocomplete="off" maxlength="4" ng-maxlength="4" valid-number>
                                </md-input-container>  
