    ...
    <div class="contdmoree" >
                ...
                <div class="estiloTarjeta">
                    <div class="titulo-treetable-solucion">
                        <div class="contenedorAsignacionSolucionario">
                            ...
                            <md-button ng-disabled="!dispCard" ng-click="asignarSolucion()"  class="md-primary estilosBotonGeneral  botonabsoluto">                                
                                Asignar Solución
                            </md-button>
                            ...
                            <div class="filtroBuscardorTabla">
                                ...
                                <md-autocomplete class="EstiloInput InputSinError inputWull buscarFull" 
                                    ...
                                    <md-not-found>
                                        <span ng-if="viewResult">No se encontraron resultados para "[[ctrl.searchItem]]".</span>
                                        <span ng-if="!viewResult">Presione ENTER para obtener resultados para "[[ctrl.searchItem]]".</span>
                                    </md-not-found>
                                </md-autocomplete>
                            </div>                                                           
        ...
        <footer class="OpcionesFooterGenerales">
            ...
            <div class="colum2 text-der alineadoDerecha">                
                <md-button ng-disabled="!validarAsignaciones()" class="md-primary estilosBotonGeneral" ng-click="siguiente()"> 
                    Continuar
                    <i class="material-icons">&#xE315;</i>
                </md-button>                 
            </div>
