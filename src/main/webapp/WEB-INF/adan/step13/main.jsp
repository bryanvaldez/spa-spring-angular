        ...
        <form name="localForm" ng-submit="localForm.$valid && ctrl.submitLocal()" novalidate >
            ...
            <section class="columnaDiviTres ">                
                ...
                <article ng-show="ctrl.section.reporteBase">                
                    <jsp:include page="/WEB-INF/adan/mantenimiento/reporteMesaSolucion.jsp"/>
                </article>  
         ...
         <footer class="OpcionesFooterGenerales">
            <div class="colum2 text-izq  alineadoIzquieda"> 
                ...
                <md-button class="md-fab md-primary botonFoter estilosBotonGeneral" ng-click="abrirFTFinal(ev)" ng-if="ctrl.stepGeneral = 13" aria-label="Use Android">
                    <i class="material-icons">&#xE431;</i>
                     <md-tooltip md-direction="top">Ficha Técnica Final</md-tooltip>
                </md-button>
            </div>          
