 ...
 */
package pe.gob.onpe.adan.filter;
...
public class SessionFilter implements Filter {
    ...
    public void doFilter(ServletRequest xrequest, ServletResponse xresponse,
        ...
        doBeforeProcessing(xrequest, xresponse);

        Throwable problem = null;
        try {
            HttpServletRequest request = (HttpServletRequest) xrequest;
            HttpServletResponse response = (HttpServletResponse) xresponse;
            String urlRedirect = request.getContextPath() + "/login?logout";
            String urlRedirectMain = request.getContextPath() + "/main";
            HttpSession session = request.getSession(false);
            String jsid = request.getSession().getId();
            if (null == session || session.getAttribute("USUARIO_AUTENTICADO") == null) {
        ...
        doAfterProcessing(xrequest, xresponse);
        ...
        if (problem != null) {
            ...
            sendProcessingError(problem, xresponse);
        }
    }
